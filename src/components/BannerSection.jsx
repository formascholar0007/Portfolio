    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r f text-black  font-Sora">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-around gap-20 items-center lg:items-start">
        <div className="lg:w-[55%] text-center lg:text-left ">
          <h1 className="text-5xl mt-8 font-bold text-zinc-800">GREDX</h1>
          <h2
        ...
        <div className="lg:w-[42%] mt-8 lg:mt-0 flex justify-center lg:justify-end">
          <img
            ...
            className="rounded-lg shadow-2xl transform rotate-3 hover:rotate-0 border-2 border-white hover:border-purple-800 transition ease-in-out delay-100 hover:shadow-purple-600"
            alt="Profile Picture"
          />
        </div>
      </div>
