...
const WhyChooseUs = () => {
  ...
  return (
    <>
      <section
        id="why-choose-us"
        className="overflow-hidden pt-20 pb-12 px-6 md:px-12 lg:pt-[120px] lg:pb-[90px] bg-white dark:bg-dark font-Sora"
      >
          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
              ...
              <div className="flex items-center -mx-3 sm:-mx-4">
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  ...
                  <div
                    className={`py-3 sm:py-4 animate__animated ${
                      isInView
                        ? "animate__fadeInLeft animate__slow animate__delay-2s"
                        : ""
                    }`}
                  >
                    <img
                ...
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  ...
                  >
                    ...
                    <span className="absolute flex -right-16 -bottom-16 z-[-1]">
                      <PiDotsNineThin
                        size={100}
                        className={`text-purple-500 animate__animated ${
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <p
                  className={`mb-8 text-base text-body-color dark:text-dark-6 animate__animated ${
                    isInView ? "animate__fadeInUp animate__slow" : ""
                  }`}
                >
                  <strong>Quality & Precision:</strong> Attention to detail and
                  a commitment to excellence ensure that every project we
